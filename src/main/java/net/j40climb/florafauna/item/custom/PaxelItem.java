...
public class PaxelItem extends DiggerItem {
    ...
    // Create class to get the strippable list from the game instead of copying it
    ...
    // Create class to get the flattenable list from the game instead of copying it
