...
public class RegisterBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        dropSelf(RegisterBlocks.TEAL_MOSS_BLOCK.get());
        dropSelf(RegisterBlocks.SYMBIOTE_CONTAINMENT_CHAMBER.get());
        dropSelf(RegisterBlocks.COPPER_GOLEM_BARRIER.get());
    ...
    protected Iterable<Block> getKnownBlocks() {
        return RegisterBlocks.BLOCKS.getEntries().stream().map(Holder::value)::iterator;
    }
}
