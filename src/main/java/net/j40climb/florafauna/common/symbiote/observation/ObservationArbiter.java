...
import net.j40climb.florafauna.common.symbiote.dialogue.DialogueSelectionContext;
...
public class ObservationArbiter {
    ...
    private static VoiceTier determineTier(
        ...
        if (severity >= TIER2_SEVERITY_THRESHOLD) {
            ...
            if (!progress.hasReachedState(conceptKey,
                    net.j40climb.florafauna.common.symbiote.progress.SignalState.SEEN)) {
                return VoiceTier.TIER_2_BREAKTHROUGH;
            }
        }
    ...
    private static void updateProgressSignals(
        ...
        if (existingSignal.isEmpty()) {
            ...
            var signal = net.j40climb.florafauna.common.symbiote.progress.ConceptSignal
        ...
        player.setData(FloraFaunaRegistry.SYMBIOTE_PROGRESS_ATTACHMENT, tracker);
    }
