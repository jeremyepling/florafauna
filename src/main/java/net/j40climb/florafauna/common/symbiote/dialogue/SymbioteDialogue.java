...
public class SymbioteDialogue {
    ...
    public static void tryTrigger(ServerPlayer player, SymbioteDialogueTrigger trigger) {
        SymbioteEventTracker tracker = player.getData(ModAttachmentTypes.SYMBIOTE_EVENT_TRACKER);
        ...
        if (trigger.isFirstTimeOnly()) {
            ...
            player.setData(ModAttachmentTypes.SYMBIOTE_EVENT_TRACKER, newTracker);
        }
